---
title: 校園帳號
slug: article/account
category: 
tags: 設備, 資訊, 帳號
publish: 2025-6-12
lastEdited: 2025-7-26
---
...
範例：學號是 `B11000000`，則mail帳號就是 `B11000000`@mail.ntust.edu.tw
## NTUST Email / 校園無線網路
- 帳號格式： `{學號}` @mail.ntust.edu.tw
- 預設密碼：新生資料袋裡面有
- 登入入口：[https://mail.ntust.edu.tw](https://mail.ntust.edu.tw/)
- **初次使用請先修改密碼再登入！！**
  - 修改密碼入口：[https://netservice.ntust.edu.tw/ChangePw/Index](https://netservice.ntust.edu.tw/ChangePw/Index)
> 💡 **【注意】**
...
- 校園無線網路(NTUST-PEAP)
### 信件轉寄
- 可以設定轉寄到妳常用的信箱，**最下方表留副本記得勾選～**
![](https://prod-files-secure.s3.us-west-2.amazonaws.com/0868253f-f80b-4d76-b97b-2d6e0a33d6c9/0bce15a8-6849-45be-ac8c-23e1a302e1f0/Untitled.png)
## 手機收信
...
- **初次使用請先修改密碼再登入！！**
![](attachment:ac517ee9-d0b8-499a-80f8-062a295cc3c2:image.png)
### 更改密碼須知
密碼需要包含以下規則
- 密碼不得少於8碼密碼
- 不得與上次密碼相同密碼
...
- 啟用路徑：[https://www.cc.ntust.edu.tw/p/412-1050-8351.php?Lang=zh-tw](https://www.cc.ntust.edu.tw/p/412-1050-8351.php?Lang=zh-tw)
  - 目前改以紙本申請，有申請就一定會過
  - 填妥申請表並檢附學生證照片，寄至[gwsapply@mail.ntust.edu.tw](mailto:gwsapply@mail.ntust.edu.tw)即可開通
- 登入入口：[https://mail.google.com/a/gapps.ntust.edu.tw](https://mail.google.com/a/gapps.ntust.edu.tw)
### 常用功能
- Google Meet (沒有時間限制版本)
- Google Drive (只有8G)
