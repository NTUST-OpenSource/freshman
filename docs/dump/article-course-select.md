...
選哪些課請自己去[GPA網站](https://myntust.com)或是Dcard等查詢哪些課比較涼，通識課的主要目的除了學習內容之外是洗GPA跟認識新同學。
...
![](attachment:1202d802-f8f6-4da8-851b-2d858db897dd:image.png)
## 學分限制
- 選課學分限制16~25/學期
...
2. Q: 可以同一時段放很多堂課嗎？ 
A: 可以
3. Q: 會不會重複中簽(同個時段中兩門課)？ 
A: 不會，當一個時段有課的時候，其他同時段的志願序會被直接捨棄
4. Q: 會不會相同的一門課中兩門？ 
A: 不會，重複課名的志願序會被捨棄
5. Q: 抽選後會不會超過25學分？ 
A: 不會，滿25學分會自動停止抽選
6. Q: 通識課最多中幾門？ 
A: 3門，但開學加退選階段可以選超過3門
7. Q: 加入志願序的時候顯示課程已達人數上限怎麼辦？ 
A: 這代表這們課已經被舊生選滿了，等看看加退選階段有沒有人退課，再進行加選
8. Q: 我沒辦法選英文課怎麼辦？ 
A: 目前新生的狀況都是還沒被分組，等開學後再進行選課
9. Q: 只要放入系統志願序就可以了嗎，需不需要點什麼送出的按鈕？ 
A: 不用，加入志願序就代表登記成功
10. Q: 志願序可以超過25學分嗎？ 
A: 可以
11. Q: 體育課只能選指定時段的嗎？ 
A: 對，如果你要選其他時段的要用加簽的(通常老師會不給加)
## 其他資料
...
- [大學部選課專區](https://www.academic.ntust.edu.tw/p/412-1048-8230.php?Lang=zh-tw)
  - 各系畢業學分
  - 雙主修、輔系相關資訊
  - 校際選課資訊
...
## 實用工具
- [GPA 計算機 (by Vic Wen)](https://college-gpacalculator.vercel.app/)
